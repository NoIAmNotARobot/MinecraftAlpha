...
public class AlphaRecipes {
    ...
    public static void registerRecipes() {
        ...
        new AlphaRecipesArmor().addRecipes();
        ...
        GameRegistry.addRecipe(
            ...
            'X',
            AlphaItem.book);
        GameRegistry.addRecipe(new ItemStack(AlphaBlock.blockSnow, 1), "##", "##", '#', AlphaItem.snowball);
        ...
        GameRegistry.addRecipe(
            new ItemStack(AlphaBlock.tnt, 1),
            "X#X",
            "#X#",
            "X#X",
            'X',
        ...
        GameRegistry.addRecipe(new ItemStack(AlphaItem.sign, 1), "###", "###", " X ", '#', AlphaBlock.planks, 'X', AlphaItem.stick);

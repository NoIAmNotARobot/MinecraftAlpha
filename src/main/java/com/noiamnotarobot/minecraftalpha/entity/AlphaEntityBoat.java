...
public class AlphaEntityBoat extends Entity {

    public float damageTaken;
    public int timeSinceHit;
    public int forwardDirection;

    public AlphaEntityBoat(World var1) {
        super(var1);
        this.damageTaken = 0;
        this.timeSinceHit = 0;
    ...
    public AlphaEntityBoat(World var1, double var2, double var4, double var6) {
        this(var1);
        ...
        if (this.damageTaken > 40) {
            if (!worldObj.isRemote) {
                ...
                for (var3 = 0; var3 < 3; ++var3) {
                    this.entityDropItem(new ItemStack(AlphaBlock.planks), 1);
                }

                for (var3 = 0; var3 < 2; ++var3) {
                    this.entityDropItem(new ItemStack(AlphaItem.stick), 1);
                }
            }
    ...
    public void onUpdate() {
        ...
        for (int var4 = 0; var4 < var1; ++var4) {
            double var5 = this.boundingBox.minY
                + (this.boundingBox.maxY - this.boundingBox.minY) * (double) (var4) / (double) var1
                - 0.125D;
            double var7 = this.boundingBox.minY
                + (this.boundingBox.maxY - this.boundingBox.minY) * (double) (var4 + 1) / (double) var1
                - 0.125D;
            AxisAlignedBB var9 = AxisAlignedBB.getBoundingBox(
        ...
        if (var12 * var12 + var25 * var25 > 0.001D) {
            var10 = ((float) (Math.atan2(var25, var12) * 180.0D / Math.PI));
        }
        ...
        List<Entity> var18 = this.worldObj
            .getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand(0.2F, 0.0D, 0.2F));
        if (var18 != null && !var18.isEmpty()) {
            for (Entity var20 : var18) {
                if (var20 != this.riddenByEntity && var20.canBePushed() && var20 instanceof AlphaEntityBoat) {

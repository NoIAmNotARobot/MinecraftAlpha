...
public class AlphaEntitySnowball extends Entity {
    ...
    public AlphaEntitySnowball(World var1) {
        super(var1);
    ...
    public AlphaEntitySnowball(World var1, Entity var2) {
        super(var1);
        this.thrower = var2;
        this.setSize(0.25F, 0.25F);
    ...
    public void onUpdate() {
        ...
        if (var3 != null) {
            if (var3.entityHit != null
                && var3.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this.thrower, this), 0)) {}
    ...
    public void onCollideWithPlayer(EntityPlayer var1) {
        if (this.inGround && this.thrower == var1

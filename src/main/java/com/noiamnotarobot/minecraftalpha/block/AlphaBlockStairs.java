...
public class AlphaBlockStairs extends AlphaBlock {
     ...
     * }
     * public void dropBlockAsItemWithChance(World var1, int var2, int var3, int var4, int var5, float var6, int
     * fortune) {
     ...
     * }
     * public boolean onBlockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5, int side, float
     * subX,

...
public class NoiseGeneratorOctaves {
    ...
    public double[] generateNoiseOctaves(double[] var1, double var2, double var4, double var6, int var8, int var9,
        int var10, double var11, double var13, double var15) {
        if (var1 == null) {
        ...
        for (int var19 = 0; var19 < this.octaves; ++var19) {
            this.generatorCollection[var19].populateNoiseArray(
                var1,
                var2,
                var4,
                var6,

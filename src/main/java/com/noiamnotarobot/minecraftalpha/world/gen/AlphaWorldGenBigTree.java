...
public class AlphaWorldGenBigTree extends AlphaWorldGenerator {
    ...
    void genTreeLayer(int var1, int var2, int var3, float var4, byte var5, Block var6) {
        ...
        label32: for (var11[var5] = var10[var5]; var12 <= var7; ++var12) {
            ...
            while (true) {
                while (true) {
                    ...
                    double var15 = Math.sqrt(
                        Math.pow((double) Math.abs(var12) + 0.5D, 2.0D)
                    ...
                    if (!(var15 > (double) var4)) {
                        ...
                        if (var14 == Blocks.air || var14 == AlphaBlock.leaves) {
    ...
    float leafSize(int var1) {
        return var1 >= 0 && var1 < this.leafDistanceLimit
            ? (var1 != 0 && var1 != this.leafDistanceLimit - 1 ? 3.0F : 2.0F)
            : -1.0F;
    }
    ...
    void generateLeafNode(int var1, int var2, int var3) {
        ...
        for (int var5 = var2 + this.leafDistanceLimit; var4 < var5; ++var4) {
            ...
            this.genTreeLayer(var1, var4, var3, var6, (byte) 1, AlphaBlock.leaves);
        }
    ...
    void generateTrunk() {
        ...
        this.placeBlockLine(var5, var6, AlphaBlock.wood);
        if (this.trunkSize == 2) {
            ++var5[0];
            ++var6[0];
            this.placeBlockLine(var5, var6, AlphaBlock.wood);
    ...
    void generateLeafNodeBases() {
        ...
        for (int[] var3 = new int[] { this.basePos[0], this.basePos[1], this.basePos[2] }; var1 < var2; ++var1) {
            ...
            if (this.leafNodeNeedsBase(var6)) {
                this.placeBlockLine(var3, var5, AlphaBlock.wood);
            }
        }
    ...
    int checkBlockLine(int[] var1, int[] var2) {
        ...
        if (var3[var5] == 0) {
            ...
            for (var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
                ...
                if (var16 != Blocks.air && var16 != AlphaBlock.leaves) {
                    break;
                }
            }
    ...
    boolean validTreeLocation() {
        ...
        if (var3 != AlphaBlock.grass && var3 != AlphaBlock.dirt) {
            return false;
        } else {
